...
public class ProductRestController {
	...
	public ProductRestController(){ 
	 ...
	 //내가 작성하다 중단....
	//json/getProduct/10000?menu=search
	//@RequestMapping("/getProduct.do")  
		@RequestMapping( value="json/getProduct/{prodNo}", method=RequestMethod.GET )
		public Map getProduct( @PathVariable int prodNo,@RequestParam("menu") String menu ) throws Exception{
		...
		//  스프링 쿠키 유지를 구글에 검색하면 굉장히 쉽게 나온다.
			...
			//UI가 이미 내려가있다
			//우리가 그 다운받아진 UI에서 알아서 나눠서 뷰를 처리할 수 있도록
			//해당 데이터만 보내주면 된다!
